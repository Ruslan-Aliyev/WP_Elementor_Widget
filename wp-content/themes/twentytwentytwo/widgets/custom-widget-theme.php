...
class CustomWidgetTheme extends Widget_Base
{
  public function get_name()
  {
    return 'custom-widget-theme';
  }

  public function get_title()
  {
    return 'Custom Widget Theme'; // Human readable
  }
  ...
  protected function render()
  {
    ...
    $this->add_render_attribute(
      'label_heading',
      [
        'class' => ['custom-widget-theme__label-heading'],
      ]
    );

    ?>
      <div class="custom-widget-theme">
        <div <?php echo $this->get_render_attribute_string('label_heading'); ?>>
          <?php echo $settings['label_heading']?>
        </div>
        <div class="custom-widget-theme__content">
          <div class="custom-widget-theme__content__heading" <?php echo $this->get_render_attribute_string('content_heading'); ?>>
            <?php echo $settings['content_heading'] ?>
          </div>
          <div class="custom-widget-theme__content__copy" <?php echo $this->get_render_attribute_string('content'); ?>>
  ...
  protected function _content_template()
  {
    ?>
      ...
      <div class="custom-widget-theme">
        ...
        <div class="custom-widget-theme__content">
          <div class="custom-widget-theme__content__heading">{{{ settings.content_heading }}}</div>
          <div class="custom-widget-theme__content__copy"> {{{ settings.content }}} </div>
        </div>
      </div>
    <?php
  }
